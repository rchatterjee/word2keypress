...
cdef class Keyboard(object):
    ...
    def __init__(self,  str _type='qwerty', float shift_discount=0.8):
        ...
        self._loc_map = {}
        self._adj_map = json.load('adjacency_graphs.json') # generated by Dropbox/python-zxcvbn
    ...
    def char2key(self, char _char, int capslock_state):
        assert self._keyboard_type == 'qwerty', "Not yet supported non-qwerty keyboards"
        cdef int r, c, shift
    ...
    def keyboard_nearby_chars(self, char _char):
        ...
        return self._adj_map.get(_char, []) # using the Dropbox adjacency grph
